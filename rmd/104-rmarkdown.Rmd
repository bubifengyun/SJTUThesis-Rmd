...
本文无意全文翻译 RMarkdown/Bookdown 的使用方法，只有简单的几个例子，详细内容请参考页面：
...
### 有序列表 {#rmd:list:orderlist}

以下是一个有序列表的例子，列表的每个条目单独分段。
...
### 公式排版 {#rmd:matheq:eqformat}

请参考第\ref{sec:eqformat}节。或者 [bookdown](https://bookdown.org/yihui/bookdown/markdown-extensions-by-bookdown.html#theorems) 相关说明。
...
请参考第\ref{sec:eqformat}节

```{theorem, pyth, name="勾股定理"}
对于直角三角形，$c$为斜边，$a$和$b$为两直角边，则
