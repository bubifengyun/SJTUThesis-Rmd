...
这里是插入图片的示例，如不想显示代码在 option 里添加 `echo=FALSE`。比如 `{r logo, out.width='32.8%', fig.show='hold', bicap=c('上海交通大学','SJTU'), echo=FALSE"}`

```{r logo, out.width='32.8%', fig.show='hold', bicap=c('上海交通大学','SJTU'), echo=FALSE}
